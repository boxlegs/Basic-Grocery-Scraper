...
## Usage
Using this tool is pretty easy. You just need to clone the repository and supply the file containing the item codes (or on the CLI if just one code), as well as the desired ntfy.sh server+endpoint if you have one. 
